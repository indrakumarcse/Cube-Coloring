...
import { GUI } from 'https://unpkg.com/three@0.172.0/examples/jsm/libs/lil-gui.module.min.js'; // Corrected import
...
function init() {
    ...
    scene.background = texture; // Set the gradient texture as the background
